# Graph Report - ant  (2026-09-14)

## Corpus Check
- 87 files · ~37,015 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1565 nodes · 2577 edges · 101 communities (91 shown, 8 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 57 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ff452e1`
...
1. `CommanderAnt` - 59 edges
2. `BuildingPlacementController` - 44 edges
3. `AntColony.Core` - 41 edges
4. `BuildingBase` - 39 edges
5. `SoldierAnt` - 39 edges
6. `WorkerAnt` - 39 edges
7. `UnitRole` - 38 edges
8. `ResourceNode` - 35 edges
9. `AntColony.Data` - 33 edges
10. `SelectionManager` - 32 edges
...
- `SelectedUnitPanel` --references--> `SelectionManager`  [EXTRACTED]
  Assets/Scripts/UI/SelectedUnitPanel.cs → Assets/Scripts/Units/SelectionManager.cs
- `AttackMoveController` --references--> `SelectionManager`  [EXTRACTED]
  Assets/Scripts/Units/AttackMoveController.cs → Assets/Scripts/Units/SelectionManager.cs
- `UnitSelectionController` --references--> `SelectionManager`  [EXTRACTED]
  Assets/Scripts/Units/UnitSelectionController.cs → Assets/Scripts/Units/SelectionManager.cs
...
Cohesion: 0.15
Nodes (11): SelectableObject, IsSelected, Color, Renderer, Transform, SelectionManager, Camera, LayerMask (+3 more)

### Community 2 - "CombatRolePrototypeBootstrapper"
Cohesion: 0.22
Nodes (7): CombatRolePrototypeBootstrapper, Barracks, GameObject, MenuItem, ResearchLab, Transform, MonoScript
...
Cohesion: 0.06
Nodes (24): SceneInvasionChecks, BuildingBase, Task, SetupFishing, Collider, Color, GameObject, Material (+16 more)

### Community 5 - "BuildingPlacementController"
Cohesion: 0.15
Nodes (11): BuildingPlacementController, ConsumesPointerInput, IsPlacing, Barracks, Camera, Collider, GameObject, LayerMask (+3 more)

### Community 6 - "SoldierAnt"
Cohesion: 0.06
Nodes (28): IAirborne, IsAirborne, SoldierAnt, IsAirborne, IsFlying, State, Attacking, AttackMoving (+20 more)
...
### Community 8 - ".Main"
Cohesion: 0.06
Nodes (32): RegressionChecks, FieldInfo, Func, GameObject, List, MeshFilter, NavMeshAgent, Object (+24 more)
...
### Community 11 - "com.unity.collections"
Cohesion: 0.12
...
Cohesion: 0.11
Nodes (8): QueenChamber, SetupCommanders, AntPool, Assigned, Free, Instance, Reserved, Total

### Community 14 - "WildMonster"
Cohesion: 0.17
Nodes (7): WildMonster, CurrentHealth, IsDead, IsFlying, Position, List, NavMeshAgent

### Community 15 - "CommanderAnt"
Cohesion: 0.08
Nodes (22): CommanderAnt, AllowedRoles, Armor, AttackDamage, CanChangeAllocation, CanStartConstruction, CarryCapacity, CommanderName (+14 more)
...
### Community 21 - "com.unity.modules.animation"
Cohesion: 0.10
...
### Community 28 - "BuildingKind"
Cohesion: 0.14
Nodes (13): BuildingData, BuildingKind, Barracks, DigSite, Farm, QueenChamber, ResearchLab, Storage (+5 more)
...
### Community 30 - ".Main"
Cohesion: 0.27
Nodes (6): CommanderProgressionChecks, MonoBehaviour, Task, Vector3, BindingFlags, MethodInfo

### Community 31 - "BuildingConstructionSite"
Cohesion: 0.21
...
### Community 35 - "UnitData"
Cohesion: 0.22
Nodes (5): MenuItem, DataAssetBootstrapper, UnitData, GameObject, GameObject
...
### Community 37 - ".Main"
Cohesion: 0.25
Nodes (5): RaidChecks, Func, MonoBehaviour, Task, UpkeepManager

### Community 38 - "com.unity.modules.uielements"
Cohesion: 0.08
Nodes (25): dependencies, dependencies, depth, source, version, depth, source, version (+17 more)
...
### Community 57 - "ObjectPool"
Cohesion: 0.31
Nodes (6): ObjectPool, Dictionary, GameObject, Quaternion, Vector3, Queue

### Community 58 - "EnemyColony"
Cohesion: 0.07
Nodes (21): EnemyColonyPlacementChecks, BuildingBase, Task, InvasionChecks, FieldInfo, Func, List, NavMeshAgent (+13 more)
...
Cohesion: 0.18
Nodes (8): CommanderRoster, Transform, UnitSelectionController, Camera, Color, LayerMask, Vector2, MonoBehaviour

### Community 61 - "GameManager"
Cohesion: 0.18
...
Cohesion: 0.17
Nodes (11): 2026-09-03~04 (세션 2), 2026-09-05 (Codex 인수인계 / SAVE 연결 검증), 2026-09-10 SAVE — 이전 로그 이관 (2026-09-09 상태), 2026-09-11 — SAVE 연결 복구, 2026-09-11 — 이전 로그 요약 및 중단 지점, 2026-09-13 SAVE — 이전 로그(2026-09-11) 이관, 2026-09-14 SAVE — 이전 로그(2026-09-13) 이관, 2026-09-14 SAVE — 이전 로그(Support 전용 버프) 이관 (+3 more)

### Community 65 - "프로젝트 로그"
Cohesion: 0.29
Nodes (6): 2026-09-14 SAVE — 적 소굴 랜덤 배치 완료, SAVE 결과, 검증, 다음 작업과 미정 사항, 프로젝트 구조와 규칙, 프로젝트 로그

### Community 66 - "com.unity.modules.imageconversion"
Cohesion: 0.18
Nodes (11): dependencies, depth, source, version, dependencies, dependencies, depth, source (+3 more)

### Community 67 - ".ConfigureCommander"
Cohesion: 0.24
Nodes (3): GameObject, List, IEnumerable

### Community 69 - "com.unity.modules.imgui"
Cohesion: 0.06
Nodes (32): dependencies, depth, source, version, dependencies, depth, source, version (+24 more)

### Community 70 - "UnitRole"
Cohesion: 0.29
...
### Community 91 - ".IsAirborne"
Cohesion: 0.24
Nodes (4): CombatTargeting, Vector3, Vector3, Vector3
...
- **Why does `BuildingBase` connect `BuildingBase` to `AntColony.Core`, `BuildingPlacementController`, `SoldierAnt`, `.Main`, `ResearchLab`, `BuildingKind`, `.Main`, `BuildingConstructionSite`, `.Main`, `QueenChamber`, `.BuildCanvas`, `IDamageable`, `EnemyColony`, `MonoBehaviour`, `GameManager`, `Barracks`, `Storage`, `.IsAirborne`, `.SetupFarm`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `CommanderAnt` connect `CommanderAnt` to `AntColony.Core`, `SoldierAnt`, `.Main`, `SelectedUnitPanel`, `.Main`, `BuildingConstructionSite`, `UnitData`, `CommanderProgression`, `.Main`, `CommanderRank`, `IDamageable`, `EnemyColony`, `MonoBehaviour`, `.ConfigureCommander`, `UnitRole`, `.Main`, `SupportChecks`, `.Main`, `.Main`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `packages-lock.json`, `com.unity.collections`, `com.unity.nuget.newtonsoft-json`, `com.unity.render-pipelines.core`, `com.unity.addressables`, `com.unity.modules.jsonserialize`, `com.unity.modules.animation`, `com.unity.burst`, `com.unity.nuget.mono-cecil`, `com.unity.test-framework`, `com.unity.modules.unitywebrequest`, `com.unity.modules.physics`, `com.unity.modules.uielements`, `com.unity.ext.nunit`, `com.unity.ai.navigation`, `dependencies`, `com.unity.modules.imageconversion`, `com.unity.modules.imgui`, `com.unity.modules.physics2d`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **What connects `게임 설명`, `현재 구현 상태`, `조작법` to the rest of the system?**
